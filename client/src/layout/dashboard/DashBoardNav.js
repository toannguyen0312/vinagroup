    ...
    return (
        <div className="nav-container">
                    <nav ref={menuRef}>
                        ...
                        <ul className={`dropdown-menu ${mobileMenuOpen ? 'show' : ''}`}>
                            <li className="nav-item">
                                <Link to="/">Home</Link>
                            </li>
                            <li className="nav-item"><Link to="/gioi-thieu">Giới Thiệu</Link></li>
                            <li className="nav-item"><Link to="/du-lich-nuoc-ngoai">Du Lịch Nước Ngoài</Link>
                            ...
                            <li className="nav-item"><Link to="/du-lich-trong-nuoc">Du Lịch Trong Nước</Link>
                                <ul className="dropdown-submenu">
